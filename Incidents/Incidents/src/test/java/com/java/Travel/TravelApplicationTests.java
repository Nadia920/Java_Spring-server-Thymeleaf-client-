...
public class TravelApplicationTests {
    ...
    @Autowired
    private IncidentLogRepository incidentLogRepo;
    ...
    private IncidentLogService incidentLogServ;
    ...
    public void init() {
        ...
        incidentLogServ = new IncidentLogServiceImpl(incidentLogRepo);
   ...
   @Test
    ...
    @Test
    public void IncidentLog() {
        String name = new String();
        List <IncidentLog> obj = incidentLogRepo.findAll();

        assertEquals(obj, null);
    }
    @Test
    public void IncidentLogSave() {
