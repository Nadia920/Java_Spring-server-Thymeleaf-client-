...
public class IncidentServiceImpl implements IncidentService {
    ...
    @Override
    public void addIncident(IncidentCreateUpdateDTO incidentDTO) {

    }

    @Override
    public void edit(IncidentCreateUpdateDTO incidentDTO) {

    }

    @Override
    public List<IncidentDTO> findAllByStatus(IncidentStatus status) {
        return null;
    }

    @Override
    public void canceledIncident(Long idTrip) {

    }

    @Override
    public List<IncidentDTO> findIncidentsByCriteria(IncidentCriteriaDTO incidentCriteriaDTO) {
        return null;
    }

    @Override
    public void save(IncidentDTO incident, String role_client) {

    }

    @Override
    public Object findAllByIncidentId(Long id) {
        return null;
    }

    @Override
    public List<IncidentDTO> findTripsByCriteria(IncidentCriteriaDTO incidentCriteriaDTO) {
        return null;
    }
