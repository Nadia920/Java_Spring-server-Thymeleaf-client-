...
public boolean save(UserDTO userDTO, String role) {
        ...
        userEntity.setFirstNameUser(userDTO.getFirstName());
        userEntity.setLastNameUser(userDTO.getLastName());
        userEntity.setPatronymicUser(userDTO.getPatronymic());
...
public void update(UserDTO user) {
        ...
        editUserEntity.get().setFirstNameUser(user.getFirstName());
        editUserEntity.get().setLastNameUser(user.getLastName());
        editUserEntity.get().setPatronymicUser(user.getPatronymic());
